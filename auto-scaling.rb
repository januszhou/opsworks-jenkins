...
def createLoadBasedInstance()
    result = `aws opsworks --region us-east-1 create-instance --stack-id 582fe17a-020f-44e9-9af6-57935f97d016 --layer-id e13e9dfd-4b78-4736-8e9a-429ca8310749 --instance-type t2.micro --auto-scaling-type load --os "Custom" --ami-id ami-5182df34 --ssh-key-name "CodeDeploy-server"`
